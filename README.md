...
- 🚀 **Multi-server**: 29 pre-configured modpacks, ready to start (add as many as you want)
...
29 servers come pre-configured — from `vanilla` (light, no API key) to
...
| [Modpack Catalog](docs/MODPACKS.md)                    | The 29 pre-configured servers: versions, RAM      |
