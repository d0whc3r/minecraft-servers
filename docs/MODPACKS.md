...
| ------------------------------- | -------------------------------------------------------------------------- | ---------- | ------ | ---------- |
| `aged`                          | [Aged](modpacks/aged.md)                                                   | 1.20.1     | 6G     | Modrinth   |
...
| `landscapes-reimagined-genesis` | [Landscapes Reimagined Genesis](modpacks/landscapes-reimagined-genesis.md) | 1.20.1     | 8G     | Modrinth   |
